...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO departments (dept_name, school) VALUES ('$dept_name', '$school')";
    if (mysqli_query($conn, $sql)) {
        header("Location: admin_departments.php?success=Department added successfully");
        exit();
    }
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Add Department | MUT DMS</title>
    ...
    <style>
        ...
        .btn-submit { background: var(--primary); color: white; border: none; padding: 12px; width: 100%; border-radius: 8px; font-weight: 600; cursor: pointer; transition: 0.3s; }
...
<body>
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <input type="text" name="dept_name" required placeholder="e.g. Computer Science">
            
            <label>School / Faculty</label>
            <input type="text" name="school" required placeholder="e.g. SBIT">
